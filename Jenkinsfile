pipeline {
    ...
    parameters {
        ...
        string(name: 'CLUSTER_SOURCE_NAME', defaultValue: '', description: 'Cluster ORIGEM (Obrigatório para FULL_MIGRATION e BACKUP)')
        string(name: 'CLUSTER_DEST_NAME', defaultValue: '', description: 'Cluster DESTINO (Obrigatório para FULL_MIGRATION e RESTORE)')
        ...
        string(name: 'ISTIO_SYNC_MODE', defaultValue: 'all', description: "Digite o nome do/dos VS's a serem restaurados (Se for mais de um, colocar os nomes separado por vírgula.)")
    }
